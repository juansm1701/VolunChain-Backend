...
describe('StellarAddress', () => {
  describe('constructor', () => {
    it('should create a valid StellarAddress with a valid public key', () => {
      const validAddress = 'GCKFBEIYTKP5RDBQMUTAPDCFZDFNVTQNXUCUZMAQYVWLQHTQBDKTQRQY';
    ...
    it('should throw error for address with wrong prefix', () => {
      expect(() => new StellarAddress('ACKFBEIYTKP5RDBQMUTAPDCFZDFNVTQNXUCUZMAQYVWLQHTQBDKTQRQY')).toThrow('Invalid Stellar address format');
    });
  });
  ...
  describe('equals method', () => {
    it('should return true for equal addresses', () => {
      const address = 'GCKFBEIYTKP5RDBQMUTAPDCFZDFNVTQNXUCUZMAQYVWLQHTQBDKTQRQY';
    ...
    it('should return false for different addresses', () => {
      const address1 = 'GCKFBEIYTKP5RDBQMUTAPDCFZDFNVTQNXUCUZMAQYVWLQHTQBDKTQRQY';
      const address2 = 'GDQNY3PBOJOKYZSRMK2S7LHHGWZIUISD4QORETLMXEWXBI7KFZZMKTL3';
