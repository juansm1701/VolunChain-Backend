...
describe('Wallet Auth Integration', () => {
  ...
  describe('register', () => {
    ...
    it('should register user with valid wallet', async () => {
      const { prisma } = require('../../../config/prisma');
      const mockUserRepository = require('../../../modules/user/repositories/PrismaUserRepository').PrismaUserRepository;
      const mockSendEmailUseCase = require('../../../modules/auth/use-cases/send-verification-email.usecase').SendVerificationEmailUseCase;
