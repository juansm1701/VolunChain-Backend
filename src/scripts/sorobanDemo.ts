// import { sorobanService } from "../services/sorobanService"; // Service moved/deleted
 ...
 * Note: This demo is disabled due to service migration
 *
 * To run this script:
...
async function sorobanDemo() {
  console.log("SorobanService demo disabled due to service migration");
  
  // TODO: Update to use new modular architecture
  // try {
